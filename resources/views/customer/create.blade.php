  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <h6 class="card-title">Tambah Customer</h6>

        <form class="forms-tambah" method="post" action="{{ route('customer.store') }}">
          @csrf
          <div class="row mb-3">
            <label for="nama_instansi" class="col-sm-3 col-form-label">Nama Instansi</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" id="nama_instansi" placeholder="Nama Instansi" name="nama_instansi" value="{{ old('nama_instansi') }}">
            </div>
          </div>
          <div class="row mb-3">
            <label for="nama_customer" class="col-sm-3 col-form-label">Nama Customer</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" id="nama_customer" placeholder="Nama Customer" name="nama_customer" value="{{ old('nama_customer') }}">
            </div>
          </div>
          <div class="row mb-3">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" id="nomer_hp" placeholder="Nomor Hp" name="nomer_hp" value="{{ old('nomer_hp') }}">
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <select class="form-select" id="segmentasi" name="segmentasi">
                <option selected disabled >Pilih Segmentasi</option>
