        ...
        <div class="row">
          ...
          <div class="col-md-8 ps-md-0">
            <div class="auth-form-wrapper px-4 py-5">
              <img src="{{ URL::asset('assets/images/dgs.png') }}" alt="dgs"  width="200"  >
              {{-- <a href="#" class="noble-ui-logo d-block mb-2">Noble<span>UI</span></a> --}}
              <h5 class="text-muted fw-normal mb-4">Welcome back! Log in to your account.</h5>

              
              <form class="forms-sample" method="post" action="{{ route('login.action') }}">
                @csrf
                <div class="mb-3">
                ...
                <div>
                  <button type="sumbit" class="btn btn-primary me-2 mb-2 mb-md-0">Login</button>
